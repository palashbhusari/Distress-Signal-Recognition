...
def run_demo(net, image_provider, height_size, cpu, track, smooth):
 ...
 # Calculating the fps
    ...
    #dectect angle between elbow and shoulder wrist.
        r_wriY, r_wriX = pose.keypoints[4][0], pose.keypoints[4][1]
        l_wriY, l_wriX = pose.keypoints[7][0], pose.keypoints[7][1]
        print("Left Elbow " ,int(angle_between_3_points(left_shoulderX,left_shoulderY,left_elbowX,left_elbowY,l_wriX,l_wriY)),"      Right elbow ", int(360 - angle_between_3_points(right_shoulderX,right_shoulderY,right_elbowX,right_elbowY,r_wriX,r_wriY)), "   ", "Left Shoulder " ,int(angle_between_3_points(right_shoulderX,right_shoulderY,left_shoulderX,left_shoulderY,left_elbowX,left_elbowY)),"      Right Shoulder ", int(360 - angle_between_3_points(left_shoulderX,left_shoulderY, right_shoulderX,right_shoulderY,right_elbowX,right_elbowY)) )
...
# fuction for calulating angles
def angle_between_3_points(x1, y1, x2, y2, x3, y3):
    """Calculates the angle between three points (x1, y1), (x2, y2), and (x3, y3)"""
    dx1 = x1 - x2
    dy1 = y1 - y2
    dx2 = x3 - x2
    dy2 = y3 - y2
